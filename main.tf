...
provider "aws" {
  region = "us-east-2"  # Changed to the preferred region
}
...
resource "aws_subnet" "testing-app_public_1" {
  ...
  availability_zone       = "us-east-2a"    # Changed to us-east-2 availability zone
...
resource "aws_subnet" "testing-app_public_2" {
  ...
  availability_zone       = "us-east-2b"    # Changed to us-east-2 availability zone
  map_public_ip_on_launch = true           
